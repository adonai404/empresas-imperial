  ...
  return <Sidebar collapsible="icon" variant="inset" className="border-r border-border w-56 data-[state=collapsed]:w-16">
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {utilitiesSubSections.map(subSection => <SidebarMenuItem key={subSection.id}>
                  <SidebarMenuButton onClick={() => onSectionChange(subSection.id)} isActive={isActive(subSection.id)} className="w-full justify-start">
        ...
        {responsaveis && responsaveis.length > 0 && <SidebarGroup>
            <SidebarGroupLabel>Por Responsável</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                {responsaveis.map(responsavel => <SidebarMenuItem key={responsavel.id}>
              ...
              }} isActive={false} className="w-full justify-start">
