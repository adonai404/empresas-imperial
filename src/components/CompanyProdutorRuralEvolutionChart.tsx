...
import { useProdutorRuralEvolutionData } from '@/hooks/useFiscalData';
...
interface CompanyProdutorRuralEvolutionChartProps {
  companyId: string;
  companyName: string;
  className?: string;
}

export const CompanyProdutorRuralEvolutionChart = ({ 
  companyId, 
  companyName, 
  className 
}: CompanyProdutorRuralEvolutionChartProps) => {
  const { data: evolutionData, isLoading, error } = useProdutorRuralEvolutionData(companyId);
